...
{%- if ( elasticsearch.major_version == 6 or elasticsearch.major_version == 5 ) and grains['os_family'] == 'Debian' %}
apt-transport-https:
  pkg.installed
{%- endif %}
...
{%- if grains.get('os_family') == 'Debian' %}
  {%- if elasticsearch.major_version == 6 or elasticsearch.major_version == 5 %}
